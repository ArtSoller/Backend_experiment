...
use App\Infrastructure\Database\Form\RolesType;
...
class RolesController extends AbstractController
{
    ...
    #[Route('/{id_role}', name: 'app_roles_show', methods: ['GET'])]
    ...
    #[Route('/{id_role}/edit', name: 'app_roles_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id_role}', name: 'app_roles_delete', methods: ['POST'])]
    public function delete(Request $request, Roles $role, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$role->getId_role(), $request->getPayload()->get('_token'))) {
